...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Table.style'
        db.add_column(u'cmsplugin_table', 'style',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Table.style'
        db.delete_column(u'cmsplugin_table', 'style')
    ...
    models = {
        ...
        u'djangocms_table.table': {
            'Meta': {'object_name': 'Table', 'db_table': "u'cmsplugin_table'", '_ormbases': ['cms.CMSPlugin']},
            ...
            'style': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
